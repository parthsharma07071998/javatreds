...
<head>
	...
	<div class="content" id="contFileUpload1">
    	...
    	<fieldset>
    		<div class="box-body">
				<div class="row">
					<input type="hidden" id="ratingFile" data-role="xuploadfield" data-file-type="BUYERRATINGZIP" />
					<div class="col-sm-4"><section><label for="ratingFile" class="label">Buyer Rating Zip File:</label></section></div>
					<div class="col-sm-8">
						<section class="">
	...
	<div class="content" id="contFileUpload">
    	...
    	<div class="xform box" id="frmUploadMain">
    		<div class="box-body">
    			<div class="row">
					<div class="col-sm-4"><section><label class="label">Buyer Rating CSV:</label></section></div>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="btn-groupX pull-right hidden" id="btn-grp-upl">
			    			<button type="button" id="upl-btn-uploadBuyerCreditrating" class="btn btn-lg btn-success"><span class="fa fa-upload"></span> Upload</button>
	...
	var crudBuyerRatingPdf$,crudBuyerRatingPdf,mainFormBuyerRatingUpl; //related to main form not upload
	...
	$(document).ready(function() {
		...
		$('#frmUploadMain #upl-btn-uploadBuyerCreditrating').on('click', function(pEvent){
			if (file$[0].files.length==1) {
				var lFldZipFile = mainFormBuyerRatingUpl.getField('ratingFile');
				...
				lData.append("pdfZipFile",lFldZipFile.getValue());
<%
...
%>
				...
				lBtn$.prop('disabled',true);
				$.ajax({
					url:'upload/data/buyercreditrating',
					data: lData,
				    cache: false,
				    contentType: false,
				    processData: false,
 ...
 */
 		lFormConfig = <%=BeanMetaFactory.getInstance().getBeanMeta(BuyerCreditRatingBean.class).getJsonConfig()%>;
		var lConfig = {
			resource:'XXX',
			fields:lFields,
		...
		crudBuyerRatingPdf$ = $('#contFileUpload1').xcrudwrapper(lConfig);
		crudBuyerRatingPdf = crudBuyerRatingPdf$.data('xcrudwrapper');
		mainFormBuyerRatingUpl = crudBuyerRatingPdf.options.mainForm;
		//
	});
	function setState() {
		var lFileName = "";
