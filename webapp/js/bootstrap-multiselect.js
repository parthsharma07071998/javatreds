...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonWidth: 'auto',
            buttonContainer: '<div class="btn-groupX" />',
        ...
        createOptionValue: function(element) {
            ...
            $('label', $li).append('<input type="' + inputType + '" name="' + this.options.checkboxName + '" /><i></i>');
        ...
        buildSelectAll: function() {
            ...
            if (!alreadyHasSelectAll && this.options.includeSelectAllOption && this.options.multiple
                ...
                $('label', $li).append('<input type="checkbox" name="' + this.options.checkboxName + '" /><i></i>');
         ...
         */
        init: function() {
        	populateOptions(this.$select, this.options.dataSetValues)
            this.rebuild();
        },
        ...
        mergeOptions: function(options) {
            ...
            return $.extend(true, {}, this.defaults, lOptions);
        },
        ...
        getValue: function() {
        	var lVal=[];
        	$.each(this.getSelected(), function(pIndex) {
        		lVal.push($(this).val());
        	});
        	return lVal.length?lVal:null;
        },
        setValue: function(pVals) {
        	this.clearSelection();
        	this.select(pVals?pVals:[], true);
        },
        focus: function() {
        },
