...
public class BHELPEMClientAdapter implements IClientAdapter {
    private static Logger logger = Logger.getLogger(BHELPEMClientAdapter.class);
	private static final String LOG_HEADER = "BHELPEMClientAdapter :: ";
	...
	public BHELPEMClientAdapter(String pEntityCode,ClientSettingsBean lClientSettingsBean){
		super();
