...
public class EDNClientAdapter implements IClientAdapter {
    private static Logger logger = Logger.getLogger(EDNClientAdapter.class);
	private static final String LOG_HEADER = "ADNClientAdapter :: ";
	...
	public EDNClientAdapter(String pEntityCode,ClientSettingsBean lClientSettingsBean){
		super();
