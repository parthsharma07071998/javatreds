...
public class FinancierFuReportMonitor implements IMonitorHandler {
	
	private final String  code = "financierFuReport";
	...
	public void appendData(Map<String, Object> pData) {
		...
		try{
			...
			lSql.append(" SELECT * FROM FinancierFuReoprt_vw  ");
			try(Connection lConnection =lDbHelper.getConnection();
				...
				while (lResultSet.next()){
					...
					lTmpData.put("Category", lResultSet.getString("CATEGORY"));
