...
public class SupplierFuReportMonitor implements IMonitorHandler {
	
	private final String  code = "supplierFuReport";
	...
	public void appendData(Map<String, Object> pData) {
		...
		try{
			...
			lSql.append(" SELECT * FROM supplierFuReoprt_vw ");
			try(Connection lConnection =lDbHelper.getConnection();
				...
				while (lResultSet.next()){
					...
					lTmpData.put("Msme", lResultSet.getString("MSME"));
