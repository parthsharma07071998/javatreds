...
@Singleton
@Path("/v1/factunitsp")
public class FactoringUnitResourceSPApiV1 {
    ...
    public static final Logger logger = Logger.getLogger(FactoringUnitResourceSPApiV1.class);

	public FactoringUnitResourceSPApiV1() {
		super();
    ...
    public String list(@Context ExecutionContext pExecutionContext, @Context HttpServletRequest pRequest, 
    	...
    	try {
			...
			lResponse = factoringUnitBO.findListSP(pExecutionContext, lUserBean, false,null,null);
    	}catch(Exception e) {
