...
public class RegistrationChargeUploader extends BaseFileUploader {
    public static final String FILE_TYPE = "REGFXLS";
    ...
    public RegistrationChargeUploader() {
        super();
	...
	public boolean onData(int pIndex, String[] pBinaryRecord, FileUploadBean pFileUploadBean) throws Exception {
        ...
        try(Connection lConnection = DBHelper.getInstance().getConnection()) {
            ...
            if ((lValidationFailBeans != null) && (lValidationFailBeans.size() > 0)) {
            	...
            	Date lEffectiveDate = registrationChargeBO.getRegistrationDate(lConnection, lRegistrationChargeBean.getEntityCode());
            	RegistrationChargeBean lRCBean = registrationChargeBO.createCharge(lConnection, lRegistrationChargeBean.getEntityCode(), lAppUserBean, ChargeType.Registration, lEffectiveDate, lRegistrationChargeBean.getRequestType() );
            	if(lRCBean != null) {
            		...
            		//
            		registrationChargeBO.updateEntityExpiryDate(lConnection, lRCBean, MemoryDBManager.getInstance().getConnection(), lAppUserBean,true);
            	}
